...
def setup(serialPort=None):
    ...
    if port is not None:
        ...
        camera.setIntegrationTime3d(0, 10000)       ## set integration time 0: 1000
        camera.setMinimalAmplitude(0, 100)          ## set minimal amplitude 0: 80
        camera.setRange(0,1000)
        camera.setIntegrationTimeGrayscale(25000)
